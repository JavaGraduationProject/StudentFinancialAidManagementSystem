		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="encourageship/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="ENCOURAGESHIP_ID" id="ENCOURAGESHIP_ID" value="${pd.ENCOURAGESHIP_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">困难等级:</td>
								<td><input type="text" name="POOR_LEVEL" id="POOR_LEVEL" value="${pd.POOR_LEVEL}" maxlength="255" placeholder="这里输入困难等级" title="困难等级" style="width:98%;"/></td>
							</tr>
							<tr>
